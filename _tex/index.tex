...
(Barrett et al., 2024), emmeans v. 1.10.0 (Lenth, 2024), lme4 v.
1.1.35.1 (Bates et al., 2015), prospectr v. 0.2.7 (Stevens \&
Ramirez-Lopez, 2024), randomForest v. 4.7.1.1 (Liaw \& Wiener, 2002),
rmarkdown v. 2.26 (Allaire et al., 2024; Xie et al., 2018, 2020),
...
CP values into tertiles according to their percent CP. Within each
tertile, 75\% of the samples were randomly assigned to the calibration
set and the remaining 25\% were assigned to the validation set.
