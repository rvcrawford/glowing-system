...
Additional analyses were performed using R Statistical Software (R Core
Team, 2024). Data were tabulated and summarized using the tidyverse and
data.table {[}Barrett et al. (2024); Wickham et al. (2019){]}. PLSR
models were constructed using the pls package and validated using caret
{[}Kuhn \& Max (2008); Liland et al. (2023){]}.
...
Hocking, T. (2024). \emph{Data.table: {Extension} of `data.frame`}.
...
\bibitem[\citeproctext]{ref-kuhn_building_2008}
Kuhn, \& Max. (2008). Building {Predictive} {Models} in {R} {Using} the
caret {Package}. \emph{Journal of Statistical Software}, \emph{28}(5),
1--26. \url{https://doi.org/10.18637/jss.v028.i05}

\bibitem[\citeproctext]{ref-liland_pls_2023}
