...
distance (RPIQ), three common model assessment metrics. Analyses of
...
literature, indicating an appropriate basis for a chemometric model. The
...
metric for model assessment. Therefore the superiority of SNV-SG as
measured via RPIQ made it the superior candidate for the choice of final
model.
...
\textbf{paragraph discussing relative merits of various preprocessing
methods}
...
importance of the selection an appropriate preprocessing method.
