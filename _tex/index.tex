...
\pandocbounded{\includegraphics[keepaspectratio]{index_files/figure-pdf/fig-model-calibration-1.pdf}}
...
The performance of the final models on the test sets were similar, but
...
between higher and lower percentage CP values (RPD range from 1.5--2.0).
Therefore, 74\% of the models had, at minimum, the ability to
...
overestimated percentage CP by approximately 0.5\% in the lowest tertile
and underestimated percentage CP by -0.01\% and -0.41\% in the middle
and highest tertile, respectively. The variance of the errors did not
increase appreciably as percentage CP increased.
