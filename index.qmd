...
preproc_key[,full_name:= c("First Derivative", "Savitzky-Golay", "Gap-segment derivative",
...
Laboratory assay percent CP values are summarized in the following table. These are similar to the range of CP values observed in the literature and indicate an appropriate basis for a chemometric model.  
