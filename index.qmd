...
Hemp (Cannabis sativa L.) is an annual crop with potential uses as a source of food or feed from grain, and bast fiber or hurd from the stalk. Hemp cultivars are commonly grown for one or both purposes.

Percentage crude protein (CP) of grain is an important consideration for researchers, producers, and consumers.
